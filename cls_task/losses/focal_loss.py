"""Copied from https://github.com/CoinCheung/pytorch-loss
Notice you should install this repository to install focal_cpp
And torch.cuda.amp as amp is only supported torch.__version__ >= 1.6
"""
