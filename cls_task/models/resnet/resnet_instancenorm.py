...
def get_resnet_in_model(model_arch, **kwargs):
    if model_arch == "res10":
        ...
        raise Exception("Resnet model of Res{} not implemented!!. You can choose one of [10, 18, 34, 50, 101, 152, 200]".format(model_arch))
